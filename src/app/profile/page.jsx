    ...
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="bg-gray-900 rounded-3xl border border-gray-800 p-6
          ...
          {/* Avatar */}
          <div className="w-20 h-20 bg-teal-700 rounded-2xl flex items-center
          ...
          <div className="text-center sm:text-left flex-1">
            ...
            <div className="flex flex-wrap justify-center sm:justify-start
                            gap-2 mt-3">
              <span className="bg-teal-900/50 border border-teal-800
                               text-teal-300 text-xs px-3 py-1 rounded-full">
                🎫 {requestCount} Requests Made
              </span>
              <span className="bg-gray-800 border border-gray-700
                               text-gray-400 text-xs px-3 py-1 rounded-full">
                ✅ Member
              </span>
            </div>
          </div>
        ...
        <div className="bg-gray-900 rounded-3xl border border-gray-800
          ...
          <div>
            ...
            <input
              ...
              value={user?.email || ''}
              disabled
              className="w-full bg-gray-800/50 border border-gray-700 rounded-xl
                         px-4 py-3 text-gray-500 text-sm cursor-not-allowed"
            />
          ...
          {message && (
            <div className="bg-green-950 border border-green-800 rounded-xl
                            px-4 py-3">
          ...
          <button
            ...
            disabled={updating}
            className="w-full bg-teal-600 hover:bg-teal-500 active:bg-teal-700
        ...
        <div className="bg-gray-900 rounded-3xl border border-gray-800
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-3
                       bg-red-950/50 hover:bg-red-950 border border-red-900
                       hover:border-red-700 rounded-xl
                       transition-all duration-200 group"
          >
            <div className="flex items-center gap-3">
              <span className="text-lg">🚪</span>
            ...
            <svg className="w-4 h-4 text-red-800 group-hover:text-red-500
                            transition-colors"
                 fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round"
                    strokeWidth={2} d="M9 5l7 7-7 7" />
